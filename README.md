...
1.  **Clone the repo**
    ```bash
    git clone [https://github.com/ue-an/SATORU-clone.git](https://github.com/ue-an/SATORU-clone.git)
    cd SAT0RU
    ```
    
    **Original repo**
    [https://github.com/reinesana/SAT0RU.git](https://github.com/reinesana/SAT0RU.git)
